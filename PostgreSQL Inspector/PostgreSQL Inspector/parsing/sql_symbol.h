...
enum sql_symbol_type
{
    ...
    sql_symbol_transaction_mode_list_tail,
    ...
    sql_symbol_token_all,
    sql_symbol_token_begin,
    sql_symbol_token_commit,
    sql_symbol_token_committed,
    sql_symbol_token_deferrable,
    sql_symbol_token_end,
    sql_symbol_token_from,
    sql_symbol_token_isolation,
    sql_symbol_token_level,
    sql_symbol_token_load,
    sql_symbol_token_only,
    sql_symbol_token_read,
    sql_symbol_token_repeatable,
